...
Remember: although canvas triangles that result from splitting a raw triangle will be flat topped/bottomed, their equivalent texture triangles will probably NOT be - so be careful ! 
